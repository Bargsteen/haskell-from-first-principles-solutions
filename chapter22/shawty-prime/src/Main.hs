...
f = (\cInfo -> R.connect cInfo >>= scotty 3000 app)

-- f :: R.ConnectInfo -> ReaderT -- R.ConnectInfo
  -- IO ()
-- f = ReaderT $ (\cInfo -> scotty 3000 (app cInfo))


-- r = withReaderT (R.Connect R.defaultConnectInfo) (ReaderT)
